	...
	<HEAD>
		...
		<script type="text/javascript">
			function addCategory(){
				window.location.href = "${pageContext.request.contextPath}/adminCategory_edit.action";
			}
		</script>
	</HEAD>
	<body>
						...
						<td class="ta_01" align="center" bgColor="#f5fafe">
							<table cellspacing="0" cellpadding="1" rules="all"
								...
								<tr
									...
									<s:iterator var="c" value="categories" status="status">
										<tr onmouseover="this.style.backgroundColor = 'white'"
											...
											<td style="CURSOR: hand; HEIGHT: 22px" align="center"
												width="17%">
												<s:property value="#c.cname"/> <br/>
												<%--

												--%>
												<s:iterator value="categorysecondsByCid" var="cs">
													<%--直接写变量名 调用当前迭代对象的属性--%>
													<s:property value="csname"></s:property>
												</s:iterator>
											</td>
