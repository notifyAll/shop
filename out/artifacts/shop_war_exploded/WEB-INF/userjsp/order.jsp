...
<div class="container cart">
		...
		<div class="span24">
			...
			<form id="orderForm" action="${ pageContext.request.contextPath }/order_payOrder.action" method="post">
				...
				<div class="span24">
					<p>
							收货地址：<input name="addr" type="text" value="<s:property value="#session.userAccount.addr"/>" style="width:350px" />
								<br />
							收货人&nbsp;&nbsp;&nbsp;：<input name="name" type="text" value="<s:property value="#session.userAccount.name"/>" style="width:150px" />
										<%--${userAccount.name}--%>
								<br /> 
							联系方式：<input name="phone" type="text"value="<s:property value="#session.userAccount.phone"/>" style="width:150px" />
