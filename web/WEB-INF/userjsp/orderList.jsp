...
<body>
	...
	<div class="container cart">
		...
		<div class="span24">
			...
			<table>
				<tbody>
					<s:iterator var="order" value="pageUtil.pageDate">
						<tr>
						...
						<s:iterator var="orderItem" value="#order.orderitemsByOid">
							<tr>
								<td width="60"><img
									src="${ pageContext.request.contextPath }/<s:property value="#orderItem.productByPid.image"/>" />
								</td>
								<td><s:property value="#orderItem.productByPid.pname" /></td>
								<td><s:property value="#orderItem.productByPid.shop_price" /></td>
					...
					<tr>
						...
						<div class="pagination">
							<span>第<s:property value="pageUtil.page" />/<s:property
								value="pageUtil.maxpage" />页 </span>
								<s:if test="pageUtil.page != 1">
								<a
									href="${ pageContext.request.contextPath }/order_findByUid.action?page=1"
									class="firstPage">&nbsp;</a>
								<a
									href="${ pageContext.request.contextPath }/order_findByUid.action?page=<s:property value="pageUtil.page-1"/>"
									class="previousPage">&nbsp;</a>
							</s:if> <s:iterator var="i" begin="1" end="pageUtil.maxpage">
							...
							</s:iterator> <s:if test="pageUtil.page != pageUtil.maxpage">
								<a class="nextPage"
									href="${ pageContext.request.contextPath }/order_findByUid.action?page=<s:property value="pageUtil.page+1"/>">&nbsp;</a>
								<a class="lastPage"
									href="${ pageContext.request.contextPath }/order_findByUid.action?page=<s:property value="pageUtil.maxpage"/>">&nbsp;</a>
							</s:if>
							</div>
							</th>
					</tr>
