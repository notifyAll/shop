...
//	判断用户名是否存在
	function checkUsername(){
		...
		// 3.打开连接
		xhr.open("GET","${pageContext.request.contextPath}/user_findByName.action?username="+username+"&time="+new Date().getTime(),true);
		// 4.发送
		xhr.send(null);
	}
						...
						<table>
							<tbody><tr>
								...
								<td>
									...
									<span id="span1"></span> <span><s:fielderror name="username"></s:fielderror> </span>
								</td>
							</tr>
							<tr>
								<th>
